-- Create exam_quiz_questions table (correct spelling)
-- Run this in Supabase SQL Editor if quiz questions are not saving
...
CREATE INDEX IF NOT EXISTS idx_exam_quiz_questions_user_id ON exam_quiz_questions(user_id);
